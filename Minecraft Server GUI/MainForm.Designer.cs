namespace Minecraft_Server_GUI
{
    partial class MainForm
    {
		...
		private void InitializeComponent()
		{
			...
			execFileSelectToolStripMenuItem = new ToolStripMenuItem();
			rconStripMenuItem = new ToolStripMenuItem();
			startRCONToolStripMenuItem = new ToolStripMenuItem();
			...
			fileToolStripMenuItem.DropDownItems.AddRange(new ToolStripItem[] { openSVFToolStripMenuItem, openSVFAtStartupToolStripMenuItem, execFileSelectToolStripMenuItem });
			...
			// 
			// execFileSelectToolStripMenuItem
			// 
			execFileSelectToolStripMenuItem.Name = "execFileSelectToolStripMenuItem";
			execFileSelectToolStripMenuItem.Size = new Size(319, 22);
			execFileSelectToolStripMenuItem.Text = "Выбрать исполняемый файл вручную";
			execFileSelectToolStripMenuItem.Click += execFileSelectToolStripMenuItem_Click;
			// 
			// rconStripMenuItem
			// 
			rconStripMenuItem.DropDownItems.AddRange(new ToolStripItem[] { startRCONToolStripMenuItem, settingsRCONToolStripMenuItem });
			rconStripMenuItem.Name = "rconStripMenuItem";
			rconStripMenuItem.Size = new Size(52, 23);
			rconStripMenuItem.Text = "RCON";
			// 
			// startRCONToolStripMenuItem
			// 
			startRCONToolStripMenuItem.Name = "startRCONToolStripMenuItem";
			startRCONToolStripMenuItem.Size = new Size(170, 22);
			startRCONToolStripMenuItem.Text = "Запустить RCON";
			startRCONToolStripMenuItem.Click += startRCONToolStripMenuItem_Click;
			// 
			// settingsRCONToolStripMenuItem
			// 
			settingsRCONToolStripMenuItem.Name = "settingsRCONToolStripMenuItem";
			settingsRCONToolStripMenuItem.Size = new Size(170, 22);
			settingsRCONToolStripMenuItem.Text = "Настройки RCON";
			settingsRCONToolStripMenuItem.Click += settingsRCONToolStripMenuItem_Click;
			// 
        ...
        private ToolStripMenuItem execFileSelectToolStripMenuItem;
        private ToolStripMenuItem rconStripMenuItem;
